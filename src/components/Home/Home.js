        ...
        <section>
            <div className='md:grid grid-cols-2 gap-4'>
                <div className='py-24 ml-2 md:ml-16'>
                    <h1 className='md:text-5xl text-xl mb-4 font-thin text-justify'>Here Is Your Favorite Laptop</h1>
                    <h1 className='md:text-4xl text-xl font-thin text-justify mb-6'>Read The Customer Review And Buy It</h1>
